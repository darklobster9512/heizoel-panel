...
export type NavItem = { label: string; icon: ReactNode; to?: "/admin" | "/admin/brandings" | "/admin/bankkonten" | "/admin/bestellungen" | "/admin/rechnung" | "/admin/emails" | "/admin/sms" | "/admin/telegram"; active?: boolean };
