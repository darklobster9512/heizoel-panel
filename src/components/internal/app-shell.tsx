...
export type NavItem = { label: string; icon: ReactNode; to?: "/admin" | "/admin/brandings" | "/admin/bankkonten" | "/admin/bestellungen" | "/admin/emails" | "/admin/sms" | "/admin/telegram"; active?: boolean };
