import { Building2, Landmark, LayoutDashboard, Mail, MessageSquareText, ShoppingCart } from "lucide-react";

import type { NavItem } from "@/components/internal/app-shell";

export function getAdminNav(active: "overview" | "brandings" | "bank" | "orders" | "emails" | "sms"): NavItem[] {
  return [
