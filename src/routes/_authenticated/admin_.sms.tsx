...
export const Route = createFileRoute("/_authenticated/admin_/sms")({
  head: () => ({ meta: [
    { title: "SMS-Vorlagen — Klaro Heizöl" },
    { name: "description", content: "Vorschau der Kunden-SMS je Branding." },
    { name: "robots", content: "noindex, nofollow" },
    { property: "og:title", content: "SMS-Vorlagen — Klaro Heizöl" },
    { property: "og:description", content: "Vorschau der Kunden-SMS je Branding." },
