...
export const Route = createFileRoute("/_authenticated/admin_/telegram")({
  head: () => ({ meta: [
    { title: "Telegram-Benachrichtigungen — Klaro Heizöl" },
    { name: "description", content: "Interne Verwaltung der Telegram-Empfänger für Bestelleingänge." },
    { name: "robots", content: "noindex, nofollow" },
    { property: "og:title", content: "Telegram-Benachrichtigungen — Klaro Heizöl" },
    { property: "og:description", content: "Interne Verwaltung der Telegram-Empfänger für Bestelleingänge." },
...
function TelegramPage() {
  ...
  return (
    <AdminPageShell active="telegram">
